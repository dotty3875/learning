...
if grade < 55:  #simple greater than lesser than to determine what to print
  print("you failed!")
else: #this can also be elif > 55: but else works here because its only 2 outcomes possible
  print("you passed!")