...
tax = 0
gift = float(input("What is the vaue of your gift? "))

if gift <= 4999:
    print("No tax!")

elif gift >= 5000 and gift <= 24999:
    tax = 100
    tax = ((gift - 5000) * 0.08) + tax
    print(f'Amount of tax: {tax} euros')

elif gift >= 25000 and gift <= 54999:
    tax = 1700
    tax = ((gift - 25000) * 0.1) + tax
    print(f'Amount of tax: {tax} euros')

elif gift >= 55000 and gift <= 199999:
    tax = 4700
    tax = ((gift - 55000) * 0.12) + tax
    print(f'Amount of tax: {tax} euros')

elif gift >= 200000 and gift <= 999999:
    tax = 22100
    tax = ((gift - 200000) * 0.15) + tax
    print(f'Amount of tax: {tax} euros')

elif gift >= 1000000:
    tax = 142100
    tax = ((gift - 1000000) * 0.17) + tax
    print(f'Amount of tax: {tax} euros')